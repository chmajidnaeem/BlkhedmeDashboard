...
// const NavItem = ({ activeIcon, inactiveIcon, label, to, isActive, notification, location }) => (
//   <RouterLink
//     to={to}
//     className={`flex items-center space-x-2 hover:bg-[#004E89] rounded ${isActive ? 'fill-[#FF8000] text-[#FF8000] stroke-[#FF8000]' : 'text-white'}`}
//   >
//     <span>
//       <img src={isActive ? activeIcon : inactiveIcon} alt={label} className="w-6 h-6" />
//     </span>
//     <span>{label}</span>
//     {notification && (
...
// const DropdownNavItem = ({ activeIcon, inactiveIcon, label, isOpen, setIsOpen, items, isActive, to }) => {
//   const location = useLocation();
...
//       <RouterLink
//         to={to}
//         className={`flex items-center justify-between rounded cursor-pointer ${isActive ? 'text-[#FF8000]' : 'text-white'}`}
...
//         ) : (
//           <MdKeyboardArrowRight className={`text-white ${isActive ? 'text-[#FF8000]' : ''}`} />
//         )}
//       </RouterLink>
//       {isOpen && (
...
//               key={idx}
//               to={item.to}
//               className={`block rounded ${location.pathname === item.to ? 'text-[#FF8000]' : 'text-white'}`}
//             >
//               {item.label}
//             </RouterLink>
//           ))}
